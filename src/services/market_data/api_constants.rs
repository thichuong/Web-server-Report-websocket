...
pub const CMC_GLOBAL_URL: &str =
    "https://pro-api.coinmarketcap.com/v1/global-metrics/quotes/latest"; // 30 sec cache

// Other APIs
pub const BASE_FNG_URL: &str = "https://api.alternative.me/fng/?limit=1"; // 5 min cache
pub const BASE_RSI_URL_TEMPLATE: &str =
    "https://api.taapi.io/rsi?secret={secret}&exchange=binance&symbol=BTC/USDT&interval=1d"; // 5 min cache
