...
impl AppConfig {
    pub fn load() -> Self {
        ...
        Self {
            ...
            port: env::var("PORT").unwrap_or_else(|_| "8081".to_string()).parse().unwrap_or(8081),
            redis_url: env::var("REDIS_URL").unwrap_or_else(|_| "redis://127.0.0.1:6379".to_string()),
            fetch_interval: env::var("FETCH_INTERVAL_SECONDS").unwrap_or_else(|_| "5".to_string()).parse().unwrap_or(5),
